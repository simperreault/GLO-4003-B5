...
public class SectionTicket extends GeneralTicket {
	...
	public SectionTicket(Event _event, ticketType _type,String _section, String _owner,double _price, double _resellprice) {
		super(_event,_type,_owner,_price, _resellprice);
		section = _section;
	}
	
	public SectionTicket(UUID _id, Event _event, ticketType _type,
			String _section, String _owner, double _price, double _resellprice) {
