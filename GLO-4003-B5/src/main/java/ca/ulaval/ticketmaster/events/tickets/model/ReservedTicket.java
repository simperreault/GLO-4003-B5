...
public class ReservedTicket extends SectionTicket {
    ...
    public ReservedTicket(Event _event, TicketType _type, String _section, String _seat, String _owner,
    ...
    public ReservedTicket(UUID _id, Event _event, TicketType _type, String _section, String _seat,
	    String _owner, double _price, double _resellprice) {
	super(_id, _event, _type, _section, _owner, _price, _resellprice);
	seat = _seat;
    }
