...
public class XmlReader {
	...
	for (int tickIter = 0; tickIter < tNodeList.getLength(); tickIter++) {
	    ...
	    tempuser.getUserTickets().add(
		    new Pair<Integer, Integer>(Integer.parseInt(tElement.getAttribute("matchId")), Integer
	...
	for (int eventIter = 0; eventIter < EventNodeList.getLength(); eventIter++) {
		 ...
		 * eElement.getAttribute("open"));
		 * System.out.println("Event ticketsTotal : " +
		 * eElement.getAttribute("ticketsTotal"));
		 * System.out.println("Event ticketsAvailable : " +
		 * eElement.getAttribute("ticketsAvailable"));
		 * System.out.println("Event Sport Name : " +
		 * ((Element)eElement.
		 * getElementsByTagName("Sport").item(0)).getAttribute("name"));
		 * System.out.println("Event Sport Gender : " +
		 * ((Element)eElement
		 * .getElementsByTagName("Sport").item(0)).getAttribute
		 * ("gender")); System.out.println("Event Sport HomeTeam : " +
		 * ((Element)eElement.getElementsByTagName("Teams").item(0)).
		 * getAttribute("home"));
		 * System.out.println("Event Sport VisitorsTeam : " +
		 * ((Element)eElement
		 * .getElementsByTagName("Teams").item(0)).getAttribute
		 * ("visitors")); System.out.println("Event Location City : " +
		 * ((Element)eElement.getElementsByTagName("Location").item(0)).
		 * getAttribute("city"));
		 * System.out.println("Event Location Stadium : " +
		 * ((Element)eElement
		 * .getElementsByTagName("Location").item(0)).getAttribute
		 * ("stadium")); System.out.println("Event Date : " +
		 * ((Element)eElement
		 * .getElementsByTagName("Location").item(0)).getAttribute
		 * ("date")); System.out.println("Event Date : " +
		 * tempEvent.getTime().toString());
		 * System.out.println("Event Section List" +
		 * tempEvent.getSectionList().toString());
		 * System.out.println("Event Ticket List" +
		 * tempEvent.getTicketList().toString());
		 */
    ...
    /*
     * public static void main(String[] args) { XmlReader xmlreader = new
     * XmlReader(); xmlreader.loadEvents(); xmlreader.loadUsers();
     * xmlreader.userAuthenticate("carloboutet"); xmlreader.loadTicket(2, 4); }
     */
}
