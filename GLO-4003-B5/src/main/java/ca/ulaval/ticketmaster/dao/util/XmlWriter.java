...
public class XmlWriter {
     ...
     * "CarloBoutet"; // Cr�er une event de test Date date = new
     ...
     * "Rouge et or", "Vert et or", "Qu�bec", "Bell", date, time, 0, 0);
     * 
     * Event event2 = EventFactory.CreateExistingEvent(eventId2, true,
     * SportType.FOOTBALL, "M", "Rouge et or", "Vert et or", "Qu�bec", "Bell",
     * date, time, 0, 0);
     * 
