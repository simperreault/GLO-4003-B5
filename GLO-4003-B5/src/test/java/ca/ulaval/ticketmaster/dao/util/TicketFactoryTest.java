...
public class TicketFactoryTest {
	...
	assertTrue(TicketFactory.CreateExistingTicket(UUID.randomUUID(), new Event(), TicketType.GENERAL,
		"1", "1", "1", 1, 0) instanceof GeneralTicket);
	assertTrue(TicketFactory.CreateExistingTicket(UUID.randomUUID(), new Event(), TicketType.RESERVED,
		"1", "1", "1", 1, 0) instanceof ReservedTicket);
	assertTrue(TicketFactory.CreateExistingTicket(UUID.randomUUID(), new Event(), TicketType.SEASON, "1",
		"1", "1", 1, 0) instanceof SectionTicket);
	assertTrue(TicketFactory.CreateExistingTicket(UUID.randomUUID(), new Event(), TicketType.SIMPLE, "1",
		"1", "1", 1, 0) instanceof SectionTicket);
